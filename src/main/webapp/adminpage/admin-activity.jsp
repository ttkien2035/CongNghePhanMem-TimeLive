...
<html>
    ...
    <body>
        <div class="page-wrapper chiller-theme toggled">
            ...
            <%
                List<Activity> listofTodos = ActivityDAO.getAllActivity();
            ...
            <main class="page-content">
                <div class="container-fluid">
                    <h2>TIME LIVE</h2>
                    <h2><b>Activity Info</b></h2>
                    <h5>Total Activity : <%= soActivity   %></h5>
                            ...
                            <table id="mytodo-table">
                                ...
                                <%
                                    for(int i=0;i<listofTodos.size();i++){
                                        Activity x = listofTodos.get(i);
                                        
                                %>
                                <tr>
                                    <td><%= x.getAcid()%></td>
                                    <td><%= x.getActivity()%></td> 
                                    <td><%= x.getTimestart()%></td>  
                                    <td><%= x.getTimeend()%></td>  
                                </tr>
                                <%
                                    }
